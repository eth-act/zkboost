...
# Example: ./download-ere-guest.sh --tag v0.17.0 --guest stateless-validator-reth-zisk-v1.1.0-alpha --output-dir ./programs/
...
usage() {
    ...
    echo ""
    echo "Options:"
    echo "  --tag         Release tag (e.g. v0.17.0)"
    echo "  --guest       Guest program name (e.g. stateless-validator-reth-zisk-v1.1.0-alpha)"
